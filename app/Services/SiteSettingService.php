...
class SiteSettingService
{
    ...
    public function identity(): array
    {
        return [
            ...
            'primary_color' => $this->get('store.primary_color', '#111111'),
            'primary_hover_color' => $this->get('store.primary_hover_color', '#2a2a2a'),
            'accent_color' => $this->get('store.accent_color', '#d99a16'),
            'topbar_color' => $this->get('store.topbar_color', '#111111'),
            'header_bg_color' => $this->get('store.header_bg_color', '#ffffff'),
            'nav_bg_color' => $this->get('store.nav_bg_color', '#ffffff'),
            'body_bg_color' => $this->get('store.body_bg_color', '#fafafa'),
            'surface_color' => $this->get('store.surface_color', '#ffffff'),
            'surface_tint_color' => $this->get('store.surface_tint_color', '#f5f6f8'),
            'text_color' => $this->get('store.text_color', '#111111'),
            'muted_text_color' => $this->get('store.muted_text_color', '#6b7280'),
            'border_color' => $this->get('store.border_color', '#e5e7eb'),
            'hero_overlay_from' => $this->get('store.hero_overlay_from', 'rgba(255,255,255,.06)'),
            'hero_overlay_to' => $this->get('store.hero_overlay_to', 'rgba(255,255,255,.42)'),
        ];
    }
