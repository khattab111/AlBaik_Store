    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Section::make(__('Customer Shipping Information'))->schema([
                ...
                Forms\Components\TextInput::make('shipping_carrier_name')->disabled(),
                Forms\Components\TextInput::make('shipping_cost')->disabled(),
                Forms\Components\TextInput::make('shipping_weight')->disabled(),
                Forms\Components\TextInput::make('shipping_delivery_time')->disabled(),
                Forms\Components\TextInput::make('shipping_town')->disabled(),
                Forms\Components\TextInput::make('shipping_street')->disabled(),
                Forms\Components\Toggle::make('is_free_shipping')->disabled(),
            ])->columns(2),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('shipping_carrier_name')->label(__('Carrier'))->toggleable(),
