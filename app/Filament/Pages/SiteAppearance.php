...
class SiteAppearance extends Page implements HasForms
{
    ...
    public function mount(SiteSettingService $settings): void
    {
        $this->form->fill([
            ...
            'store_primary_color' => $settings->get('store.primary_color', '#b91c1c'),
            'store_primary_hover_color' => $settings->get('store.primary_hover_color', '#991b1b'),
            'store_accent_color' => $settings->get('store.accent_color', '#f59e0b'),
            'store_topbar_color' => $settings->get('store.topbar_color', '#020617'),
            'store_header_bg_color' => $settings->get('store.header_bg_color', '#ffffff'),
            'store_nav_bg_color' => $settings->get('store.nav_bg_color', '#ffffff'),
            'store_body_bg_color' => $settings->get('store.body_bg_color', '#f8fafc'),
            'store_surface_color' => $settings->get('store.surface_color', '#ffffff'),
            'store_surface_tint_color' => $settings->get('store.surface_tint_color', '#fff5f5'),
            'store_text_color' => $settings->get('store.text_color', '#0f172a'),
            'store_muted_text_color' => $settings->get('store.muted_text_color', '#64748b'),
            'store_border_color' => $settings->get('store.border_color', '#e2e8f0'),
            'store_hero_overlay_from' => $settings->get('store.hero_overlay_from', 'rgba(2,6,23,.96)'),
            'store_hero_overlay_to' => $settings->get('store.hero_overlay_to', 'rgba(185,28,28,.52)'),
    ...
    public function save(): void
    {
        ...
        $this->saveValue('store.primary_color', 'identity', $data['store_primary_color'] ?? $settings->get('store.primary_color', '#b91c1c'));
        $this->saveValue('store.primary_hover_color', 'identity', $data['store_primary_hover_color'] ?? $settings->get('store.primary_hover_color', '#991b1b'));
        $this->saveValue('store.accent_color', 'identity', $data['store_accent_color'] ?? $settings->get('store.accent_color', '#f59e0b'));
        $this->saveValue('store.topbar_color', 'identity', $data['store_topbar_color'] ?? $settings->get('store.topbar_color', '#020617'));
        ...
        $this->saveValue('store.body_bg_color', 'identity', $data['store_body_bg_color'] ?? $settings->get('store.body_bg_color', '#f8fafc'));
        $this->saveValue('store.surface_color', 'identity', $data['store_surface_color'] ?? $settings->get('store.surface_color', '#ffffff'));
        $this->saveValue('store.surface_tint_color', 'identity', $data['store_surface_tint_color'] ?? $settings->get('store.surface_tint_color', '#fff5f5'));
        $this->saveValue('store.text_color', 'identity', $data['store_text_color'] ?? $settings->get('store.text_color', '#0f172a'));
        $this->saveValue('store.muted_text_color', 'identity', $data['store_muted_text_color'] ?? $settings->get('store.muted_text_color', '#64748b'));
        $this->saveValue('store.border_color', 'identity', $data['store_border_color'] ?? $settings->get('store.border_color', '#e2e8f0'));
        $this->saveValue('store.hero_overlay_from', 'identity', $data['store_hero_overlay_from'] ?? $settings->get('store.hero_overlay_from', 'rgba(2,6,23,.96)'));
        $this->saveValue('store.hero_overlay_to', 'identity', $data['store_hero_overlay_to'] ?? $settings->get('store.hero_overlay_to', 'rgba(185,28,28,.52)'));
