...
class StorefrontPageRenderingTest extends TestCase
{
    ...
    public function test_authenticated_storefront_pages_render(): void
    {
        ...
        UserAddress::create(['user_id' => $user->id, 'label' => 'Home', 'recipient_name' => 'Test User', 'phone' => '+963900000000', 'city_id' => $city->id, 'address_line' => 'Main Street', 'is_default' => true, 'is_active' => true]);
