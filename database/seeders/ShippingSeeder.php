...
class ShippingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $rates = [
            ['carrier' => 'alharam', 'city' => 'damascus', 'base' => 3.00, 'kg' => 0.50, 'max' => null, 'threshold' => 150, 'delivery' => '24-48h', 'remote' => 0],
            ['carrier' => 'alharam', 'city' => 'aleppo', 'base' => 4.00, 'kg' => 0.65, 'max' => null, 'threshold' => 180, 'delivery' => '2-4 days', 'remote' => 0],
            ['carrier' => 'alharam', 'city' => 'idlib', 'base' => 3.00, 'kg' => 0.50, 'max' => null, 'threshold' => 120, 'delivery' => '2-3 days', 'remote' => 0],
            ['carrier' => 'express-courier', 'city' => 'damascus', 'base' => 6.00, 'kg' => 1.25, 'max' => 20, 'threshold' => 250, 'delivery' => 'Same day', 'remote' => 0],
            ['carrier' => 'express-courier', 'city' => 'aleppo', 'base' => 7.00, 'kg' => 1.50, 'max' => 15, 'threshold' => 300, 'delivery' => '24-48h', 'remote' => 1.50],
            ['carrier' => 'electronics-secure', 'city' => 'damascus', 'base' => 8.00, 'kg' => 1.10, 'max' => 10, 'threshold' => 500, 'delivery' => '24h', 'remote' => 0],
            ['carrier' => 'electronics-secure', 'city' => 'latakia', 'base' => 9.00, 'kg' => 1.35, 'max' => 10, 'threshold' => 600, 'delivery' => '2-3 days', 'remote' => 2.00],
        ];
        ...
        foreach ($rates as $rate) {
            ...
            ShippingRate::updateOrCreate([
                ...
                'estimated_delivery_time' => $rate['delivery'],
