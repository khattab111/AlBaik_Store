...
class ShopSeeder extends Seeder
{
    ...
    private function seedPaymentMethods(): array
    {
        return [
            ...
            'wallet' => PaymentMethod::updateOrCreate(['slug' => 'wallet'], ['name' => $this->tr('Pay with wallet', 'الدفع من المحفظة'), 'type' => 'wallet', 'description' => $this->tr('Pay instantly from your store wallet balance.', 'ادفع مباشرة من رصيد محفظتك داخل المتجر.'), 'image' => null, 'wallet_url' => null, 'barcode_image' => null, 'settings' => [], 'fee' => 0, 'is_active' => true]),
        ];
    }
